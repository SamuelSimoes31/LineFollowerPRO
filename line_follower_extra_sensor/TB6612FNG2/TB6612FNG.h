...
#define TB6612FNG_PWM_PERIOD_DEFAULT      (0.00001)   // 50KHz
...
public:
    ...
    void motorB_cw(void);
    void user_forward(float l, float r);
    void user_left(float l, float r);
    void user_right(float l, float r);
    void user_backward(float l, float r);
